...
import { buildRecipeCommand, cleanRecipeCommand, runTaskCommand } from './ui/BitbakeCommands'
...
export async function activate (context: vscode.ExtensionContext): Promise<void> {
  ...
  context.subscriptions.push(vscode.commands.registerCommand('bitbake.run-task', async () => { await runTaskCommand(bitbakeWorkspace, bitbakeTaskProvider) }))
